# Generated by Django 4.2.16 on 2024-12-23 04:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('main', '0002_choice_question_remove_cart_customer_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='cart',
            name='customer',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='main.customer', verbose_name='Клиент'),
        ),
        migrations.AddField(
            model_name='cart',
            name='orders',
